...
export default function TaskStats() {
    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            ...
            <div className="card text-center p-4">
                <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Completadas</p>
            ...
            <div className="card text-center p-4">
                <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Vencidas</p>
                <p className="text-2xl font-bold text-red-600">{overdueCount}</p>
            </div>
            <div className="card text-center p-4 col-span-2 md:col-span-1">
                <p className="text-gray-500 dark:text-gray-400 text-sm font-medium">Progreso</p>
